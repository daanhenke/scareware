...
namespace sw::draw
{
	...
	#undef DrawText
	void DrawText(iface::HFont font, std::wstring text, int x, int y, iface::Color color = iface::Color(0, 0, 0, 255));
	void DrawShadedText(iface::HFont font, std::wstring text, int x, int y, iface::Color color = iface::Color(0, 0, 0, 255), int offset_x = 2, int offset_y = 2, iface::Color bg_color = iface::Color(0, 0, 0, 200));
}